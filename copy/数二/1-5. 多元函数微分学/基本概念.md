...
> - 除 [[../1-1. 函数的极限与连续/洛必达法则]] 和 [[../1-2. 数列极限/单调有界原则]] 以外，可照搬一元函数求极限的方法求二重极限，如
> 	- 唯一性；
> 	- 局部有界性；
> 	- 局部保号性；
> 	- 运算规则；
> 	- 脱帽法。
> - [[../1-1. 函数的极限与连续/等价无穷小]] 替换、[[../1-1. 函数的极限与连续/夹逼准则]] 等技巧也是可以用的。
...
![[../assets/deriv_hill.png]]

偏导数只考虑沿 $x$ 轴或沿 $y$ 轴的变化率，是方向导数的特殊情况。

![[../assets/partial_deriv.png]]
...
> [!note] 
> 回忆 [[../1-3. 一元函数微分学/1. 概念/微分的概念]]

把正方形 $x$ 换成长方形 $x,y$ ：

![[../assets/multi_deriv.png]]
...
> - 一元函数和多元函数在极限存在、连续、可导、可微的联系与区别：![[../assets/multi_comp.png]]
